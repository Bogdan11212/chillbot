...
class Menu_Select(disnake.ui.StringSelect):
    ...
    def __init__(self):
        options = [
            disnake.SelectOption(label="Роли" , description="роли гильдии" , emoji="🎮"),
            disnake.SelectOption(label="Правила" , description="правила гильдии" , emoji="📚"),
            disnake.SelectOption(label="Команды" , description="мои команды" , emoji="⌨️"),
        ]
...
class Menu(commands.Cog):
    ...
    async def on_connect(self):
        ...
        view = disnake.ui.View(timeout=None) 
        view.add_item(Menu_Select())  
        self.bot.add_view(view , message_id=self.DataBase.settings_data("Nav"))
